package com.hotmall.library.coreutils.io;

import android.util.Log;

import com.hotmall.library.coreutils.logging.Logger;
...
public class IOUtils {
    ...
    public static String readStream(InputStream in) {
        ...
        try {
            ...
            Logger.e(IOUtils.class.getSimpleName(), "Error reading stream", e);
        } finally {
            safeClose(in);
            safeClose(reader);
        }
