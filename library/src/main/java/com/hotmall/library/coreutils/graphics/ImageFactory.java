package com.hotmall.library.coreutils.graphics;
...
import com.hotmall.library.coreutils.view.ViewCompatibility;
...
public class ImageFactory {
    ...
    public static Bitmap decodeFile(String pathName, View view, int maxWidth, int maxHeight, boolean dontScale) {
        ...
        if (viewWidth > 0)
            maxWidth = Math.min(viewWidth, maxWidth);

        if (viewHeight > 0)
            maxHeight = Math.min(viewHeight, maxHeight);
