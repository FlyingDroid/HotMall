package com.hotmall.library.coreutils.collections;

import android.support.annotation.NonNull;


import com.hotmall.library.coreutils.functions.Predicate;
import com.hotmall.library.coreutils.functions.PredicateGroup;
import com.hotmall.library.coreutils.util.observable.lists.ListObserver;
import com.hotmall.library.coreutils.util.observable.lists.ObservableList;
import com.hotmall.library.coreutils.util.observable.lists.ObservableListWrapper;
import com.hotmall.library.coreutils.util.observable.lists.SimpleListObserver;
import com.hotmall.library.coreutils.util.observable.lists.SimpleListObserverListener;
...
public class FilteredList<T> implements ObservableList<T> {
    ...
    public FilteredList(ObservableList<T> sourceList, Predicate<T> filter) {
        this(sourceList, new PredicateGroup<>(true, filter));
    }
     ...
     *
     * @param sourceList The list to be filtered.
     * @param filters    The group of filters to apply to the list.
     */
